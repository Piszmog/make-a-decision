...
```shell
go build -o ./app -ldflags="-X github.com/Piszmog/wheel-of-decisions/internal/version.Value=1.0.0" ./cmd/server
```
...
attach all the binaries, and published the docker image. See release [v1.0.2](https://github.com/Piszmog/github.com/Piszmog/wheel-of-decisions/releases/tag/v1.0.2) as an example.
